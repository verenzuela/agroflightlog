...
<html>
  <head>
    ...
    <meta charset='@yield("metaCharset", "UTF-8")'>
    <meta name="description" content='@yield("metaDescription", "AgroFlightLog")'>
    <meta name="keywords" content='@yield("metaKeywords", "drone,vuelos,agricultura,cultivos,fumigacion")'>
    <meta name="author" content='@yield("metaAutor", "AgroFlightLog")'>
  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <script src="{{ asset ("/jquery-validation-1.17.0/dist/jquery.validate.js") }}" type="text/javascript"></script>
